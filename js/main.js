...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let x;window.customElements.define("custom-style",C),x=o.a._mutablePropertyChange;Boolean;var M=i(3);i.d(t,"a",(function(){return H})),i.d(t,"b",(function(){return M.a}));
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const k=new class{handleAttributeExpressions(e,t,i,n){const a=t[0];if("."===a){return new H(e,t.slice(1),i).parts}return"@"===a?[new L(e,t.slice(1),n.eventContext)]:"?"===a?[new M(e,t.slice(1),i)]:new w(e,t,i).parts}handleTextExpression(e){return new x(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * Copyright 2018 The Pennsylvania State University
 * @license Apache-2.0, see License.md for full text.
 */class re extends(M(n.a)){static get template(){return n.b`
      <style>
        :host {
          display: block;
 ...
 * @license Apache-2.0, see License.md for full text.
 */
class de extends(M(n.a)){static get template(){return n.b`
      <style is="custom-style">
        :host {
          padding: 0;
          margin: 0;
 ...
 * @license Apache-2.0, see License.md for full text.
 */
class ye extends(x(n.a)){static get template(){return n.b`
      <style include="editable-table-styles">
        :host {
